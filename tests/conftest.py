...
def lenient_contract(pm):
  ...
  c = pm('rayeaster/on-chain-pricer@0.3').OnChainPricingMainnetLenient.deploy(univ3simulator.address, balancerV2Simulator.address, {"from": accounts[0]})
